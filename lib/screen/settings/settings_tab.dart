...
//         children: [
//           Text(AppLocalizations.of(context)!.language,style: provider.appTheme==ThemeMode.dark?
...
//             ),
//           ),
//           Text(AppLocalizations.of(context)!.theme,style: provider.appTheme==ThemeMode.dark?
//           Theme.of(context).textTheme.titleLarge!.copyWith(
//               color: MyTheme.whiteColor
//           ):
//           Theme.of(context).textTheme.titleLarge
